 ...
 * All rights reserved.  
 *  
 * File Name: TermsAndConditions.js  
 * Description: This file is responsible to show Terms and Conditions. 
 *  
...
function TermsAndConditions() {
  return <>
    <div className="container-fluid app-secondary-color">
      <div className="row" style={{ height: "100%" }}>
        ...
        <div className="col-12 mt-3">
          <h6> Last updated December 13, 2024</h6>
        </div>
        <div className="col-12">
          <h5 >AGREEMENT TO OUR LEGAL TERMS</h5>
          <p>We are SiClarity, Inc. ("Company," "we," "us," "our"), a company registered in California, United States at 333 West Maude Avenue, Suite 207, Sunnyvale, CA 94085.</p>
          <p>We operate the website <a href="http://www.siclarity.com" target="_blank" rel="noopener noreferrer">http://www.siclarity.com</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").</p>
          <p>You can contact us by email at contact@siclarity.com or by mail to 333 West Maude Avenue, Suite 207, Sunnyvale, CA 94085, United States.</p>
          <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and SiClarity, Inc., concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
        ...
        <div className="col-12">
          ...
          <ol>
            ...
            <li><a href="#section4">USER REGISTRATION</a></li>
            <li><a href="#section5">PRODUCTS</a></li>
            <li><a href="#section6">PURCHASES AND PAYMENT</a></li>
            <li><a href="#section7">REFUNDS POLICY</a></li>
            <li><a href="#section8">PROHIBITED ACTIVITIES</a></li>
            <li><a href="#section9">USER GENERATED CONTRIBUTIONS</a></li>
            <li><a href="#section10">CONTRIBUTION LICENSE</a></li>
            <li><a href="#section11">THIRD-PARTY WEBSITES AND CONTENT</a></li>
            <li><a href="#section12">SERVICES MANAGEMENT</a></li>
            <li><a href="#section13">PRIVACY POLICY</a></li>
            <li><a href="#section14">MODIFICATIONS AND INTERRUPTIONS</a></li>
            <li><a href="#section15">GOVERNING LAW</a></li>
            <li><a href="#section16">DISPUTE RESOLUTION</a></li>
            <li><a href="#section17">CORRECTIONS</a></li>
            <li><a href="#section18">DISCLAIMER</a></li>
            <li><a href="#section19">LIMITATIONS OF LIABILITY</a></li>
            <li><a href="#section20">INDEMNIFICATION</a></li>
            <li><a href="#section21">USER DATA</a></li>
            <li><a href="#section22">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
            <li><a href="#section23">CALIFORNIA USERS AND RESIDENTS</a></li>
            <li><a href="#section24">MISCELLANEOUS</a></li>
            <li><a href="#section25">CONTACT US</a></li>
          </ol>
        </div>
        <div className="col-12">
          <h5 id="section1" >1. OUR SERVICES</h5>
        ...
        <div className="col-12">
          <h5 id="section2">2. INTELLECTUAL PROPERTY RIGHTS</h5>
          ...
          <p>Subject to your compliance with these Legal Terms, including the <a href="#section8">"PROHIBITED ACTIVITIES"</a> section below, we grant you a non-exclusive, non-transferable, revocable license to:</p>
          <ul>
          ...
          <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: contact@siclarity.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
          <p>We reserve all rights not expressly granted to you in and to the Services, Content, and Marks.</p>
          <p>Any breach of these Intellectual Property Rights will constitute a material breach of our Legal Terms and your right to use our Services will terminate immediately.</p>
          <h6>Your submissions</h6>
          <p>Please review this section and the <a href="#section8">"PROHIBITED ACTIVITIES"</a> section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.</p>
          ...
          <ul>
            <li>confirm that you have read and agree with our <a href="#section8">"PROHIBITED ACTIVITIES"</a> and will not post, send, publish, upload, or transmit through the Services any Submission that is illegal, harassing, hateful, harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening to any person or group, sexually explicit, false, inaccurate, deceitful, or misleading:</li>
        ...
        <div className="col-12">
          <h5 id="section3" >3. USER REPRESENTATIONS</h5>
        ...
        <div className="col-12">
          <h5 id="section4">4. USER REGISTRATION </h5>
          <p>
            You may be required to register to use the Services. You agree to keep your password confidential and will be responsible for all use of your account and password. We reserve the right to remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.
          </p>
        </div>
        <div className="col-12">
          <h5 id="section5">5. PRODUCTS</h5>
          <p>
            All products are subject to availability. We reserve the right to discontinue any products at any time for any reason. Prices for all products are subject to change.          </p>
        </div>
        <div className="col-12">
          <h5 id="section6">6. PURCHASES AND PAYMENT</h5>
          <p>
        ...
        <div className="col-12">
          <h5 id="section7" >7. REFUNDS POLICY
          </h5>
          <p>
            All sales are final and no refund will be issued.          </p>
        </div>
        <div className="col-12">
          <h5 id="section8">8. PROHIBITED ACTIVITIES
          </h5>
          <p>
            You may not access or use the Services for any purpose other than that for which we make the Services available. The Services may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.          </p>
          <p>As a user of the Services, you agree not to:
          </p>
          <ul>
            <li>Systematically retrieve data or other content from the Services to create or compile, directly or indirectly, a collection, compilation, database, or directory without written permission from us. Trick, defraud, or mislead us and other users, especially in any attempt to learn sensitive account information such as user passwords.</li>
        ...
        <div className="col-12">
          <h5  id="section9">9. USER GENERATED CONTRIBUTIONS </h5>
          <p>
          ...
          <ul>
            ...
            <li>Your Contributions are not used to harass or threaten (in the legal sense of those terms) any other person and to promote violence against a specific person or class of people. Your Contributions do not violate any applicable law, regulation, or rule.</li>
        ...
        <div className="col-12">
          <h5  id="section10">10. CONTRIBUTION LICENSE
          </h5>
          <p>
            You and Services agree that we may access, store, process, and use any information and personal data that you provide following the terms of the Privacy Policy and your choices (including settings).          </p>
        ...
        <div className="col-12">
          <h5 id="section11">11. THIRD-PARTY WEBSITES AND CONTENT
          </h5>
          <p>
        ...
        <div className="col-12">
          <h5 id="section12">12. SERVICES MANAGEMENT
          </h5>
          <p>
        ...
        <div className="col-12">
          <h5 id="section13">13. PRIVACY POLICY
          </h5>
          <p>
            We care about data privacy and security. Please review our Privacy Policy: <a href="https://www.siclarity.com/privacy-policy"   target="_blank" rel="noopener noreferrer">http://www.siclarity.com/privacy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.
          </p>
        </div>
        <div className="col-12">
          <h5 id="section14">14. TERM AND TERMINATION
          </h5>
          <p>
        ...
        <div className="col-12">
          <h5 id="section15">15. MODIFICATIONS AND INTERRUPTIONS
          </h5>
          <p>
            We accept the following forms of payment:
          </p>
        ...
        <div className="col-12">
          <h5 id="section16">16. GOVERNING LAW
          </h5>
          <p>
            These Legal Terms and your use of the Services are governed by and construed in accordance with the laws of the State of California applicable to agreements made and to be entirely performed within the State of California, without regard to its conflict of law principles. </p>
        </div>
        <div className="col-12">
          <h5 id="section17">17. DISPUTE RESOLUTION
          </h5>
          <h6>Binding Arbitration
          </h6>
          <p>
            If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved by binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitration shall be commenced and conducted under the Commercial Arbitration Rules of the American Arbitration Association ("AAA") and, where appropriate, the AAA's Supplementary Procedures for Consumer Related Disputes ("AAA Consumer Rules"), both of which are available at the <a href="https://www.adr.org/">American Arbitration Association (AAA) website</a>. Your arbitration fees and your share of arbitrator compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. If such costs are determined by the arbitrator to be excessive, we will pay all arbitration fees and expenses. The arbitration may be conducted in person, through the submission of documents, by phone, or online. The arbitrator will make a decision in writing, but need not provide a statement of reasons unless requested by either Party. The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except where otherwise required by the applicable AAA rules or applicable law, the arbitration will take place in Santa Clara, California. Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter judgment on the award entered by the arbitrator.          </p>
          <p>If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in Santa Clara, California, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Legal Terms.</p>
        ...
        <div className="col-12">
          <h5 id="section20">20. LIMITATIONS OF LIABILITY
          </h5>
          <p>
        ...
        <div className="col-12">
          <h5 id="section21">21. INDEMNIFICATION
          </h5>
          <p>
        ...
        <div className="col-12">
          <h5 id="section24">24. CALIFORNIA USERS AND RESIDENTS
          </h5>
          <p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p>
        </div>
        <div className="col-12">
          <h5 id="section25">25. MISCELLANEOUS
          </h5>
        ...
        <div className="col-12">
          ...
          <p className="pb-4">SiClarity, Inc. <br />
            333 West Maude Avenue <br />
            Suite 207 <br />
            Sunnyvale, CA 94085 <br />
            United States <br />
            contact@siclarity.com</p>
        </div>
      </div>
    </div>
  </>;
