...
const SaveAdminTechFileModalBody = ({ adminTechFileName, setAdminTechFileName, renameTechFileErrorMessage}) => {
    ...
    <div className="d-flex align-items-center flex-column w-100">
      <div className='d-flex align-items-center mb-2 w-100'>
        <input
          ...
          value={adminTechFileName}
          onChange={(e) => setAdminTechFileName(e.target.value)}
...
export default SaveAdminTechFileModalBody
